...
.. code-block:: python
   ...
   ax = plot2d(plot='barplot',
               ...
               ytick_add='Rp(_)',
               ytext='h',
               title='Bar total_bill vs day',
               errorbar=('ci', 95))

.. image:: ../_static/plots/barplot.png
   :alt: Bar plot of total_bill by day with confidence intervals
   :align: center
...
.. code-block:: python
   ...
   ax = plot2d(plot='barplot', 
               ...
               xtick_add='Rp(_)',
               xtext='v',
               title='Bar day vs total_bill',
               hue='sex',
               errorbar=('ci', 95))

.. image:: ../_static/plots/barplot_ex2.png
   :alt: Bar day vs total_bill
   :align: center
