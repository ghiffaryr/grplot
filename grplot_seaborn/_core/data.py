...
from grplot_seaborn._core.typing import DataSource, VariableSpec, ColumnName
...
class PlotData:
    ...
    def _assign_variables(
        ...
        -------
        frame
            Table mapping grplot_seaborn variables (x, y, color, ...) to data vectors.
        names
