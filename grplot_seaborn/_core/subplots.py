...
if TYPE_CHECKING:  # TODO move to grplot_seaborn._core.typing?
    from grplot_seaborn._core.plot import FacetSpec, PairSpec
    from matplotlib.figure import SubFigure


class Subplots:
    """
    Interface for creating and using matplotlib subplots based on grplot_seaborn parameters.
    ...
    def init_figure(
        ...
        """Initialize matplotlib objects and add grplot_seaborn-relevant metadata."""
