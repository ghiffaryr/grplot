...
def kdeplot(
    ...
    **kwargs,
    ...
    if vertical is not None:
        ...
        This will become an error in grplot_seaborn v0.14.0; please update your code.
        """)
    ...
    if bw is not None:
        ...
        and update your code. This will become an error in grplot_seaborn v0.14.0.
        """)
        warnings.warn(msg, UserWarning, stacklevel=2)
        bw_method = bw
...
def rugplot(
    ...
    if a is not None:
        ...
        Please update your code; This will become an error in grplot_seaborn v0.14.0.
        """)
        warnings.warn(msg, UserWarning, stacklevel=2)
...
def distplot(a=None, bins=None, hist=True, kde=True, rug=False, fit=None,
    ...
    This function has been deprecated and will be removed in grplot_seaborn v0.14.0.
    ...
    `distplot` is a deprecated function and will be removed in grplot_seaborn v0.14.0.
