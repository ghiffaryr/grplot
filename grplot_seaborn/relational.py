...
palette : string, list, dict, or matplotlib colormap
    ...
    It can be the name of a grplot_seaborn palette or matplotlib colormap, a list
...
def relplot(
    ...
    **kwargs
    ...
    if legend:
        ...
        # We're selective because some kwargs may be grplot_seaborn function specific
...
{params.rel.legend}
kind : string
    Kind of plot to draw, corresponding to a grplot_seaborn relational plot.
